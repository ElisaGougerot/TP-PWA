...
async function searchGIFs() {
   // disableSearch();
    ...
    // TODO: 9a -  9b 
    const url = 'http://api.giphy.com/v1/gifs/search?q='+query+'&api_key=TJKZaZjDlUGT4lpltv69hrS3qlQxgNKT&limiter=24';
    ...
    try {
        ...
        fetch(url, options).then(res => 
            ...
            //9h - Display a message in console in case of error ok
            console.log(e)
        );
    } catch (e) {
